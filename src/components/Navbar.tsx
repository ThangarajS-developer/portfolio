  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-[#090712]/85 border-b border-purple-950/60 shadow-[0_4px_30px_rgba(0,0,0,0.5)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-purple-900/60 via-purple-950 to-black border border-purple-600/40 flex items-center justify-center shrink-0 shadow-[0_0_15px_rgba(168,85,247,0.25)] group-hover:border-purple-500 group-hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] transition-all">
